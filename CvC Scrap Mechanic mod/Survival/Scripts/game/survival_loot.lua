...
lootTables.loot_woc = {
	...
	randomLoot = {
	{ uuid = obj_resource_steak,				chance = 1,		quantity = 3 },
	}
}
...
lootTables.loot_totebot_green = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_resource_circuitboard,		chance = 3,		quantity = randomStackAmountAvg2 },
		{ uuid = obj_consumable_component,		chance = 1,		quantity = randomStackAmountAvg1 },
	}
}
...
lootTables.loot_haybot = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_component,		chance = 3,		quantity = randomStackAmountAvg2 },
		{ uuid = obj_resource_circuitboard,		chance = 1,		quantity = randomStackAmountAvg1 },
	}
}
...
lootTables.loot_tapebot = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_battery,		chance = 2,		quantity = randomStackAmountAvg5 },
...
lootTables.loot_farmbot = {
	...
	randomLoot = {
		...
		{ uuid = obj_survivalobject_keycard,	chance = 2 },
	}
}
