...
DriverSeat.Levels = {
	...
	[tostring(obj_interactive_driverseat_01)] = { maxConnections = 10, allowAdjustingJoints = false, upgrade = obj_interactive_driverseat_02, cost = 1, title = "#{LEVEL} 1" },
	[tostring(obj_interactive_driverseat_02)] = { maxConnections = 14, allowAdjustingJoints = false, upgrade = obj_interactive_driverseat_03, cost = 2, title = "#{LEVEL} 2" },
	[tostring(obj_interactive_driverseat_03)] = { maxConnections = 18, allowAdjustingJoints = true, upgrade = obj_interactive_driverseat_04, cost = 3, title = "#{LEVEL} 3" },
	[tostring(obj_interactive_driverseat_04)] = { maxConnections = 20, allowAdjustingJoints = true, upgrade = obj_interactive_driverseat_05, cost = 5, title = "#{LEVEL} 4" },
...
DriverSaddle.Levels = {
	[tostring(obj_interactive_driversaddle_01)] = { maxConnections = 10, allowAdjustingJoints = false, upgrade = obj_interactive_driversaddle_02, cost = 1, title = "#{LEVEL} 1" },
	[tostring(obj_interactive_driversaddle_02)] = { maxConnections = 14, allowAdjustingJoints = false, upgrade = obj_interactive_driversaddle_03, cost = 2, title = "#{LEVEL} 2" },
	[tostring(obj_interactive_driversaddle_03)] = { maxConnections = 18, allowAdjustingJoints = true, upgrade = obj_interactive_driversaddle_04, cost = 3, title = "#{LEVEL} 3" },
	[tostring(obj_interactive_driversaddle_04)] = { maxConnections = 20, allowAdjustingJoints = true, upgrade = obj_interactive_driversaddle_05, cost = 5, title = "#{LEVEL} 4" },
