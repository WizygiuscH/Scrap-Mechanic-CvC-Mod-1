...
local FireRange = 26.0
local FireLaneWidth = 0.8
local ShotsPerBarrage = 5
...
local DeathExplosionTime = 2
local AllyRange = 20.0
local MeleeBreachLevel = 7
local HearRange = 80.0
...
function FarmbotUnit.server_onCreate( self )
	...
	if self.saved.stats == nil then
		self.saved.stats = { hp = 1000, maxhp = 1000 }
	end
	...
	self.rangedAttack.spreadAngle = 10.0
	self.rangedAttack.cooldown = 0.5
