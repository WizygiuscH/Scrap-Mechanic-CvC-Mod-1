...
function HaybotUnit.server_onCreate( self )
	...
	self.attackState01.damage = 26
	self.attackState01.attackRange = 1.9
	...
	self.attackState02.damage = 26
	self.attackState02.attackRange = 1.9
	...
	self.attackState03.attackRange = 1.9
	...
	self.attackStateSprint01.attackRange = 1.9
